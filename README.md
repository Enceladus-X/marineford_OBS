...
1. GitHub Releases에서 `Marineford_OBS_v1.3.exe`를 다운로드합니다.
...
1. 송출컴에서 `Marineford_OBS_v1.3.exe` 또는 `start_marineford.bat`을 실행합니다.
...
빌드 결과는 `dist/Marineford_OBS_v1.3.exe`에 생성됩니다.
